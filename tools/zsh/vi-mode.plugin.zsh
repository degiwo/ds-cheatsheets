...
typeset -g VI_MODE_CURSOR_NORMAL=${VI_MODE_CURSOR_NORMAL:=1}
typeset -g VI_MODE_CURSOR_VISUAL=${VI_MODE_CURSOR_VISUAL:=6}
typeset -g VI_MODE_CURSOR_INSERT=${VI_MODE_CURSOR_INSERT:=5}
...
typeset -g INSERT_MODE_INDICATOR="%F{yellow}-- INSERT --%f"
typeset -g MODE_INDICATOR="%F{white}-- NORMAL --%f"
